...
class _GeneralHomeState extends State<BlessedHome> {
...
return Container(
            color:const Color.fromARGB(255, 47, 120, 193),
            child: Row(
  ...
  void _loadSongs () async {
     ...
     final songz = await DatabaseHelper().getFruits_bles();
     songDesc = await DatabaseHelper().getAllSongs_bles();
     final infoz = await DatabaseHelper().getSongInfos_bles();
  ...
  Widget build(BuildContext context) {
   ...
   return WillPopScope(
    ...
    child: Scaffold(
      ...
      appBar: AppBar(
        //centerTitle: true,
        backgroundColor: const Color.fromARGB(255, 47, 120, 193),
              ...
              onPressed: () {
                timeDilation = 2.0; // slows down animations speed 
                 _fabVisible? Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => DonateScreen(choir_Id: 2,))): null;},
              //color:   Colors.white,
            ),
            SizedBox(width: 10.0,),
            IconButton(
                onPressed: (){
                  _fabVisible? Navigator.push(context,
                    MaterialPageRoute(builder:(context)=>AddSong(fruits: songs, choir_Id: 2,))): null;
                    },
              icon: Icon(Icons.add),
              color: Colors.white,
              ),
