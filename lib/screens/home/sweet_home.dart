...
return Container(
  ...
  void _loadSongs () async {
     ...
     final songz = await DatabaseHelper().getFruits_Sw();
     songDesc = await DatabaseHelper().getAllSongs_Sw();
     final infoz = await DatabaseHelper().getSongInfos_Sw();
              ...
              onPressed: () {
                timeDilation = 2.0; // slows down animations speed 
                 _fabVisible? Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => DonateScreen(choir_Id: 13,))): null;},
              //color:   Colors.white,
            ),
            SizedBox(width: 10.0,),
            IconButton(
               highlightColor: Colors.blue,
                onPressed: (){
                  _fabVisible? Navigator.push(context,
                    MaterialPageRoute(builder:(context)=>AddSong(fruits: songs, choir_Id: 13,))): null;
                    },
              icon: Icon(Icons.add),
              color: Colors.white,
              ),
  ...
  final ButtonStyle bnStyle = TextButton.styleFrom(
    backgroundColor: Colors.transparent,// Background color
      foregroundColor: Colors.white,
    textStyle: TextStyle(fontSize: 26, fontFamily: 'VarelaRound', fontWeight: FontWeight.bold, color: Colors.white),
    
  );
  final TextStyle textStyle = TextStyle(
    fontSize: 28, fontFamily: 'VarelaRound', fontWeight: FontWeight.bold, color: Colors.white
  );
              ...
              Expanded(
               ...
               child:  Column(
                 ...
                 mainAxisAlignment: MainAxisAlignment.center,
                  ...
                  /*SizedBox(
                        width: 20, // Set width for small buttons
                        height: 20, // Set height for small buttons
                        child: IconButton(
                          icon: Text(''),
                          highlightColor: Colors.blue,
                      ...
                      Row(
                        ...
                        children: [
                          for (int i = 1; i <= 3; i++)
                             SizedBox(
                        width: 90, // Set width for small buttons
                        height: 80, // Set height for small buttons
                        child: IconButton(
                          iconSize: 24,
                          ...
                          icon: Text(i.toString(), style: textStyle,),
                     ...
                     SizedBox(
                      width: 90, // Set width for small buttons
                        ...
                        child: IconButton(
                          ...
                          highlightColor: Colors.blue,
                          splashColor: Colors.blue,
                          icon: Text('OK',  style:  numberController.text.isEmpty? textStyleNull: textStyle,),
                       
                      
              onPressed: () {
                 if (numberController.text.isNotEmpty){
                 double? selectedNumber = double.tryParse(numberController.text);
                if (selectedNumber != null && selectedNumber >= 0.0 && selectedNumber <= songs.length-10) {
