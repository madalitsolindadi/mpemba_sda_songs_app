...
return Container(
            color: const Color.fromARGB(255, 110, 31, 134), 
            child: Row(
  ...
  void _loadSongs () async {
     ...
     final songz = await DatabaseHelper().getFruits_family();
     songDesc = await DatabaseHelper().getAllSongs_family();
     final infoz = await DatabaseHelper().getSongInfos_family();
  ...
  Widget build(BuildContext context) {
   ...
   return WillPopScope(
    ...
    child: Scaffold(
      ...
      appBar: AppBar(
        //centerTitle: true,
        backgroundColor:  const Color.fromARGB(255, 110, 31, 134),
              ...
              onPressed: () {
                timeDilation = 2.0; // slows down animations speed 
                 _fabVisible? Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => DonateScreen(choir_Id: 7,))): null;},
              //color:   Colors.white,
            ),
            SizedBox(width: 10.0,),
            IconButton(
                onPressed: (){
                  _fabVisible? Navigator.push(context,
                    MaterialPageRoute(builder:(context)=>AddSong(fruits: songs, choir_Id: 7,))): null;
                    },
              icon: Icon(Icons.add),
              color: Colors.white,
              ),
