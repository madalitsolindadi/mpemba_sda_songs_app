...
class ZibodaHome extends StatefulWidget {

  const ZibodaHome({super.key});
  @override
  _GeneralHomeState createState() => _GeneralHomeState();
}

class _GeneralHomeState extends State<ZibodaHome> {
...
return Container(
            color: const Color.fromARGB(255, 120, 98, 161),
            child: Row(
  ...
  void _loadSongs () async {
     ...
     final songz = await DatabaseHelper().getFruits_zib();
     songDesc = await DatabaseHelper().getAllSongs_zib();
     final infoz = await DatabaseHelper().getSongInfos_zib();
  ...
  Widget build(BuildContext context) {
   ...
   return WillPopScope(
    ...
    child: Scaffold(
      ...
      appBar: AppBar(
        //centerTitle: true,
        backgroundColor:   const Color.fromARGB(255, 120, 98, 161),  
              ...
              onPressed: () {
                timeDilation = 2.0; // slows down animations speed 
                 _fabVisible? Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => DonateScreen(choir_Id: 17,))): null;},
              //color:   Colors.white,
            ),
            SizedBox(width: 10.0,),
            IconButton(
                onPressed: (){
                  _fabVisible? Navigator.push(context,
                    MaterialPageRoute(builder:(context)=>AddSong(fruits: songs, choir_Id: 17,))): null;
                    },
              icon: Icon(Icons.add),
              color: Colors.white,
              ),
