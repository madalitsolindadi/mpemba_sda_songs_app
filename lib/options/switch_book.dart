...
class _SwitchHymnalState extends State<SwitchHymnal> {
  final TextStyle textStyle =
      TextStyle(fontSize: 18, fontFamily: 'VarelaRound', color: Colors.black);
